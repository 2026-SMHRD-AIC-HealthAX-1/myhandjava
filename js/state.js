...
const state = {
  ...
  exercise: {step:0, picked:null, camPhase:'idle', camStream:null, timerId:null, seconds:0, result:null, retakesUsed:0, liveReps:[], replayOpen:false, sessionId:null, rewardEligible:true, ticketUsed:false},
  crewBattle: null, // 크루대전(2vs2~5vs5) 진행 중 상태 — enterCrewBattleFromServer() 참고
  crewParty: {open:false, statusOpen:false, selected:[], invites:null, ready:false, tickId:null}, // 크루대전 파티맺기 — openPartyInvite() 참고
  // 크루대전 자동 매칭 신청 폼 — 몇 명이서(teamSize) 누구랑(participantIds) 나갈지 고르는 중간 상태.
  // 제출하면 requestMatchedCrewBattle()이 이 값 그대로 POST /api/crew-battles에 실어 보낸다.
  crewBattleSetup: {open:false, teamSize:5, participantIds:[]},
  crewBattles: [], // GET /api/crew-battles/me 목록 캐시 — loadMyCrewBattles() 참고
  crewBattleResults: {}, // battleId -> GET /{id}/result 상세 캐시(참가자별 정확도·EXP) — loadCrewBattleResultDetail() 참고
  crewBattleHistoryOpenId: null, // 대전 결과 목록에서 "자세히보기"로 펼친 battleId
  ...
  shopItems: [
    ...
    {name:'네온 트레이닝복', price:300, owned:false, equipped:false, slot:'outfit', category:'상의', layer:40, image:{male:'assets/items/male/neon-top.png',female:'assets/items/female/neon-top.png'}, fit:{male:{x:0,y:0,w:1,h:1},female:{x:0,y:0,w:1,h:1}}, levelReq:5, effect:'능력치 없음 · 외형 전용', effectDesc:'캐릭터가 실제 네온 트레이닝 상의를 착용합니다.'},
    {name:'네이비 트레이닝 하의', price:250, owned:false, equipped:false, slot:'bottom', category:'하의', layer:45, image:{male:'assets/items/male/training-pants.png',female:'assets/items/female/training-pants.png'}, fit:{male:{x:0,y:0,w:1,h:1},female:{x:0,y:0,w:1,h:1}}, levelReq:1, effect:'능력치 없음 · 외형 전용', effectDesc:'캐릭터가 실제 트레이닝 하의를 착용합니다.'},
    {name:'오렌지 러닝화', price:350, owned:false, equipped:false, slot:'shoes', category:'신발', layer:50, image:{male:'assets/items/male/orange-shoes.png',female:'assets/items/female/orange-shoes.png'}, fit:{male:{x:0,y:0,w:1,h:1},female:{x:0,y:0,w:1,h:1}}, levelReq:1, effect:'능력치 없음 · 외형 전용', effectDesc:'캐릭터가 실제 러닝화를 착용합니다.'},
    ...
    {name:'챔피언 왕관', price:900, owned:false, equipped:false, slot:'crown', category:'헤어', layer:80, image:{male:'assets/items/male/crown.png',female:'assets/items/female/crown.png'}, fit:{male:{x:0,y:0,w:1,h:1},female:{x:0,y:0,w:1,h:1}}, levelReq:10, effect:'랭킹 점수 +5%', effectDesc:'캐릭터 머리에 실제 왕관을 착용합니다.'},
    ...
    {name:'운동 추가권', price:200, owned:false, consumable:true, category:'기타', levelReq:1, icon:'🎟️', effect:'일일 운동세트 +3', effectDesc:'하루에 가능한 운동세트 한도가 3세트 늘어납니다.'},
  ],
  // 상점 진입 시 특정 카테고리 하나만 보여서 아이템이 없는 것처럼 보이지 않도록 전체 목록을 기본 표시합니다.
  shopFilter: '전체',
  itemPreview: {open:false, idx:null},
  crew: {
    created:false, name:'', desc:'', region:'', concepts:[],
    members:[],
    battleContributions:[], // 크루대전에 실제로 참여한 크루원만의 닉네임·누적 점수 (loadCrewBattleContributions 참고)
    notices:[
